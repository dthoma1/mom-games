...
const creatorBook=BOOKS.find(book=>book.id==="creator");
if(creatorBook){
  creatorBook.parts.push({
    tko:"2부 · 크리에이터로 수익 만들기",
    ten:"Part 2 · Earning as a Creator",
    games:[{
      key:"creatormoney",
      url:"creator-money-game/",
      tko:"콘텐츠로 수익 만들기",
      ten:"How Creators Get Paid",
      sko:"AdSense와 인스타그램 수익화의 원리와 조건",
      sen:"How AdSense and Instagram monetization work and what they require"
    },{
      key:"creatorplan",
      url:"creator-business-plan-game/",
      tko:"현실적인 사업 계획 만들기",
      ten:"A Realistic Creator Plan",
      sko:"한 플랫폼에 집중하는 부담 없는 90일 계획",
      sen:"A manageable 90-day plan focused on one platform"
    }]
  });
}
